...
class LittletonForecastPage extends StatefulWidget {
  @override
  _LittletonForecastPageState createState() => _LittletonForecastPageState();
}

class _LittletonForecastPageState extends State<LittletonForecastPage> {
  ...
  Future getForecast() async {
    http.Response response = await http.get(
        "https://api.openweathermap.org/data/2.5/onecall?lat=39.6133&lon=-105.0166&units=imperial&appid=cede032f308595f7c8c256d0de8e31a6");
        ...
        body: Column(
          children: <Widget>[
            Container(
              ...
              child: CityName("Littleton, Colorado")
            ),
            Container(
              height: 10,
