...
class Peoria extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<Peoria> {
  var temp;
  var feels_like;
  var description;
  var currently;
  ...
  Future getWeather() async {
    http.Response response = await http.get(
        "http://api.openweathermap.org/data/2.5/weather?q=Peoria&units=imperial&appid=cede032f308595f7c8c256d0de8e31a6");
                  ...
                  children: <Widget>[
                    ...
                    FlatButton.icon(
                      ...
                      onPressed: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => PeoriaForecastPage()),
                        );
                      },
                    ),
                  ],
